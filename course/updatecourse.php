                        ...
                        <div class="col-md-12">
                            <form action="update.php" method="post">
                                ...
                                <fieldset>
                                    ...
                                    <?php
                                    echo "<input class='input-sm' type='text' name='id' value='$_GET[id]'/>";
                                    ?>    

                                    <label for="title">Course Title : </label>

                                    <?php
                                    echo "<input class='input-sm' type='text' name='title' value='$_GET[title]'/>";
                                    ?>  

                                    <label for="title">Course Code : </label>

                                    <?php
                                    echo "<input class='input-sm' type='text' name='code' value='$_GET[code]'/>";
                                    ?> 

                                    <input class="btn-success btn-lg"  type="submit" name="submitBtn" value="Submit"/>
